...
class PoolConnectionProxyMeta(type):
    def __new__(mcls, name, bases, dct, *, wrap=...):  # -> Self:
        ...
...
class Pool:
    ...
    async def fetchrow(self, query, *args, timeout=..., record_class=...):
    ...
    async def fetchmany(self, query, args, *, timeout=..., record_class=...):
