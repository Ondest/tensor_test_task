...
class Connection(metaclass=ConnectionMeta):
    ...
    def add_query_logger(self, callback):  # -> None:
    ...
    def remove_query_logger(self, callback):  # -> None:
    ...
    async def fetchmany(self, query, args, *, timeout: float = ..., record_class=...):
    ...
    def get_reset_query(self):  # -> str | LiteralString:
    ...
    def query_logger(self, callback):  # -> Generator[None, Any, None]:
...
class _StatementCache:
    ...
    def set_max_size(self, new_size):  # -> None:
        ...
    def get_max_lifetime(self):  # -> Any:
        ...
    def set_max_lifetime(self, new_lifetime):  # -> None:
        ...
    def get(self, query, *, promote=...):  # -> Any | None:
        ...
    def has(self, query):  # -> bool:
        ...
    def put(self, query, statement):  # -> None:
        ...
    def iter_statements(self):  # -> Generator[Any, None, None]:
        ...
    def clear(self):  # -> None:
        ...
